...
export const START_TEXT =
  "안녕하십니까? 충남대학교 평생교육원입니다. 2026학년도 1학기 수강생 여러분의 의견을 듣고, 교육과정 운영 개선 및 2학기 교육계획 수립에 반영하고자 만족도 조사를 실시합니다. 응답은 통계 목적으로만 활용되며 개인식별정보는 수집하지 않습니다. 잠시만 시간을 내어 참여해 주시면 감사하겠습니다.";
